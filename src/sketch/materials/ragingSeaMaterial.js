...
uniform float uEdgeFadeSoftness;
...
void main()
{
	...
	float edgeFade = smoothstep(0.0, uEdgeFadeSoftness, edgeDistance);
	float alpha = mix(1.0, edgeFade, uEdgeFadeEnabled);
...
export function createRagingSeaMaterial(parameters) {
	return new THREE.ShaderMaterial({
		vertexShader,
		fragmentShader,
		uniforms: {
			uTime: { value: 0 },
			uBigWavesElevation: { value: parameters.seaBigWavesElevation },
			uBigWavesFrequency: {
				value: new THREE.Vector2(
					parameters.seaBigWavesFrequencyX,
					parameters.seaBigWavesFrequencyY,
				),
			},
			uBigWavesSpeed: { value: parameters.seaBigWavesSpeed },
			uSmallWavesElevation: { value: parameters.seaSmallWavesElevation },
			...
			uColorMultiplier: { value: parameters.seaColorMultiplier },
			uEdgeFadeEnabled: { value: parameters.seaEdgeFadeEnabled ? 1 : 0 },
			uEdgeFadeSoftness: { value: parameters.seaEdgeFadeSoftness },
		},
