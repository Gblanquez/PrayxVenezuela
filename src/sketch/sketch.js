...
class PrayScene {
	constructor() {
		...
		this.parameters = this.loadParameters({
			...
			seaBigWavesElevation: 0.043,
			seaBigWavesFrequencyX: 0.289,
			seaBigWavesFrequencyY: 0.535,
			seaBigWavesSpeed: 0.656,
			seaSmallWavesElevation: 0.078,
			seaSmallWavesFrequency: 11.562,
			seaSmallWavesSpeed: 0.411,
			seaSmallIterations: 4,
			seaColorOffset: 0.029,
			seaColorMultiplier: 5.698,
			...
			deviceStrengthY: 0.328,
			fogEnabled: true,
			fogColor: '#707070',
			fogDensity: 0.032,
			volumetricEnabled: true,
			volumetricColor: '#ffffff',
			volumetricOpacity: 0.447,
			volumetricX: -0.49,
			volumetricY: 3.94,
			volumetricZ: -2.2,
			volumetricRotationX: 1.74840734641021,
			volumetricRotationY: -1.18159265358979,
			volumetricRotationZ: -0.181592653589793,
			volumetricScaleX: 20,
